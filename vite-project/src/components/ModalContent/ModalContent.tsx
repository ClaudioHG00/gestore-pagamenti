            ...
            <div className="modal-content">
                    <form onSubmit={handleSubmit} className="form-inserimento">
                        ...
                        <div className="form-row">
                            ...
                            type="text" 
                            name="tipo" 
                            value={metodoPagamentoModificato.tipo} 
                        ...
                        <div className="form-row">
                            ...
                            type="text" 
                            name="numeroConto" 
                            value={metodoPagamentoModificato.numeroConto} 
                            onChange={handleChange}/>
                        </div>
                        <div className="form-row">
                            ...
                            type="date" 
                            name="dataScadenza" 
                            // value={metodoPagamentoModificato.dataScadenza.toDateString()} 
                            // Formatto in YYYY-MM-DD e mi assicuro che sia un tipo Date con new Date()
                            value={
                                metodoPagamentoModificato.dataScadenza
                                    ? new Date(metodoPagamentoModificato.dataScadenza).toISOString() 
                                    : ''
                            }
                            onChange={handleChange}/>
                        </div>
                        <div className="form-row">
                            ...
                            value={metodoPagamentoModificato.codiceSicurezza} 
                            onChange={handleChange}/>
                        </div>
                        <div className="form-row">
